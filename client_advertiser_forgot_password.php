                ...
                <div class="signup-content">
                    <form method="POST" action="#" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="email" class="form-input" name="client_advertiser_email" id="email" placeholder="Enter Your Email"Required>
                        </div>
                    ...
                    <?php
                                    ...
                                    if(isset($_POST['submit']))
                                    {
                                       ...
                                       if($count == 1)
                                       {
                                          ...
                                          $send_email=$row['client_advertiser_email'];
                                          $name = "Forgot Password";
                                          $email ="vads826@gmail.com";
                                          $msg="Thanks for contacting Us \n Your Password is :". $row['client_advertiser_password'];
