                    ...
                    <p>
                                    ...
                                    if(isset($_POST['submit']))
                                    {
                                     ...
                                     $id=$_SESSION['owner_id'];
                                       $qry="select * from vehicle_owners where vehicle_owners_id='$id' and vehicle_owners_password='$pass'";
                                     $result=mysqli_query($con,$qry) or die(mysqli_error());
                                      $count=mysqli_num_rows($result);
                                       if($count == 1)
                                       {
                                         $q="update vehicle_owners set vehicle_owners_password=$pas2  where vehicle_owners_id='$id'";
                                          mysqli_query($con,$q);
