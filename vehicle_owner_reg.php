                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Vehicle Owner Register</li>
                            </ol>
                        </nav>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="signup-content">
                    <form method="POST"  id="signup-form" class="signup-form" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-input" name="vehicle_owners_name" id="name" placeholder="Your Name"Required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        <input type="text" class="form-input" name="vehicle_owners_contact" id="name" placeholder="Your Contact number"Required>
                        </div>
                        <div class="form-group">
                    ...
                    <p class="loginhere">
                        Have already an account ? <a href="vehicle_owner_login.php" class="loginhere-link">Login here</a>
                    </p>
                    <p>
                    <?php
                                            if(isset($_POST['submit']))
                                              {
                                                ...
                                                $target="aadhaar_card/";
                                                 ...
                                                 $qry1="select * from vehicle_owners where vehicle_owners_email='$email'";
                                                ...
                                                {
                                              $date=date('Y-m-d');
                                               $qry="insert into vehicle_owners values('"."','".$_POST['vehicle_owners_name']."','".$_POST['vehicle_owners_email']."','".$_POST['vehicle_owners_password']."','".$_POST['vehicle_owners_contact']."','$date','0','$img')";
