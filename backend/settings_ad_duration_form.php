                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="val-username" name="ad_duration" placeholder="Enter duration..." Required>
                                                    </div>
</div>
                                            ...
                                            if(isset($_POST['submit']))
                                              {
                                               ...
                                               $qry="insert into settings_ad_duration values('','".$_POST['ad_duration']."')";
