               ...
               <div class="col-lg-6">
                   <div class="single-event-list mt-30">
                       <div class="event-thum">
                           <img src="vehicle_images/<?php echo $row['ad_places'];?>"height="150"width="150" >
                       </div>
                       <div class="event-cont">
                            ...
                            <span><a href="vehicle_owner_adplaces_edit.php?id=<?php echo $row['vehicle_owners_vehicle_adplace_id']?>">Edit</a></span>
                            <span><a href="vehicle_owners_vehicle_adplace_delete.php?id=<?php echo $row['vehicle_owners_vehicle_adplace_id']?>">Delete</a></span> 
                       </div>
                   </div>
               </div>
